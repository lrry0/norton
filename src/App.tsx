      ...
      <header className="sticky top-0 z-40 bg-white border-b border-gray-150 shadow-xs">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-4">
            {/* Header Direct Download Button Integration (Commented out for future URL integration)
            <a 
              href="#"
              onClick={(e) => {
                e.preventDefault();
                triggerToast('Downloading Norton Security Installer...');
              }}
      ...
      <section className="bg-[#424242] text-white pt-14 pb-32 md:pb-36 lg:pb-40 relative overflow-visible">
        ...
        <div className="absolute left-1/2 bottom-0 translate-y-1/2 -translate-x-1/2 w-[92%] max-w-5xl px-4 z-20">
          <div className="rounded-3xl bg-[#F5F2EB] border border-[#E6E1D5] p-5 md:p-8 shadow-xl flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
            ...
            {/* Promo Right Button */}
            <div className="flex flex-col items-center gap-3 md:items-end w-full sm:w-auto">
              <a
                ...
                className="w-full sm:w-40 inline-flex items-center justify-center rounded-full bg-[#FFE600] border-2 border-black hover:bg-[#E6CE00] text-xs md:text-sm font-extrabold text-slate-950 py-2 md:py-2.5 transition-all duration-100 active:scale-95 shadow-md shrink-0 cursor-pointer hover:scale-[1.02]"
              >
                Download
              </a>
              ...
              <a
                ...
                className="w-full sm:w-40 inline-flex items-center justify-center rounded-full bg-white border-2 border-black hover:bg-slate-100 text-xs md:text-sm font-extrabold text-slate-950 py-2 md:py-2.5 transition-all duration-100 active:scale-95 shadow-md shrink-0 cursor-pointer hover:scale-[1.02]"
              >
                Verify 2FA
              </a>
            </div>
